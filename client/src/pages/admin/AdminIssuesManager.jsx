    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className=" grid  md:grid-cols-2 lg:grid-cols-3 gap-6">
        {issues.map((issue) => (
          <div
            key={issue._id}
            className="border p-4 dark:bg-gray-800 text-white rounded-xl  shadow-2xl hover:scale-105 transition-transform duration-300"
          >
            <div className="flex flex-col gap-2 ">
              ...
              <label className="text-md text-black font-medium mr-2">
                Update Status:
              </label>
              <select
                value={issue.status}
